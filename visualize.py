...
yolov8_cls_name_dict={0: 'person', 1: 'bicycle', 2: 'car', 3: 'motorcycle', 4: 'airplane', 5: 'bus', 6: 'train', 
...
def plot_tracking(image, tlwhs, obj_ids,obj_clss, scores=None, frame_id=0, fps=0., ids2=None,model_type=None,thing_classes=None):
    ...
    for i, tlwh in enumerate(tlwhs):
        ...
        if model_type == 'yolox':
            ...
            if model_type=='yolov8':
                cls_name=yolov8_cls_name_dict[obj_clss[i]]
            if model_type=='ovd':
                cls_name=thing_classes[int(obj_clss[i])]
            id_text = '{}'.format(int(obj_id))+', {}'.format(cls_name)
        if ids2 is not None:
